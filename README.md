...
```sh
npm install git+ssh://git@github.com:stainless-sdks/eesuhntest-typescript.git
```
...
1. Via the `EESUHNTEST_LOG` environment variable
...
const client = new Eesuhntest({
  logger: logger.child({ name: 'Eesuhntest' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/eesuhntest-typescript/issues) with questions, bugs, or suggestions.
