...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['EESUHNTEST_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['EESUHNTEST_LOG'] or 'warn' if it isn't set.
   */
...
export class Eesuhntest {
  ...
  constructor({
    ...
    if (baseURL && opts.environment) {
      throw new Errors.EesuhntestError(
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('EESUHNTEST_LOG'), "process.env['EESUHNTEST_LOG']", this) ??
      defaultLogLevel;
  ...
  static Eesuhntest = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static EesuhntestError = Errors.EesuhntestError;
