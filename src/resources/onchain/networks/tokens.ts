...
export class Tokens extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.onchain.networks.tokens.getMultipleTokens(
   *     'addresses',
   *     { network: 'eth' },
   *   );
   * ```
  ...
  getMultipleTokens(
    addresses: string,
    params: TokenGetMultipleTokensParams,
    options?: RequestOptions,
  ): APIPromise<TokenGetMultipleTokensResponse> {
...
export interface TokenGetMultipleTokensResponse {
  data?: TokenGetMultipleTokensResponse.Data;

  included?: Array<TokenGetMultipleTokensResponse.Included>;
}

export namespace TokenGetMultipleTokensResponse {
...
export interface TokenGetMultipleTokensParams {
  /**
