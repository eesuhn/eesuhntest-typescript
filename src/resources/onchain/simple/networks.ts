...
export class Networks extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.onchain.simple.networks.getTokenPrice(
   *     'addresses',
   *     { network: 'eth' },
   *   );
   * ```
  ...
  getTokenPrice(
    addresses: string,
    params: NetworkGetTokenPriceParams,
    options?: RequestOptions,
  ): APIPromise<NetworkGetTokenPriceResponse> {
...
export interface NetworkGetTokenPriceResponse {
  data?: NetworkGetTokenPriceResponse.Data;
}

export namespace NetworkGetTokenPriceResponse {
...
export interface NetworkGetTokenPriceParams {
  /**
